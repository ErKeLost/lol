...
<template>
  <div class="app">
    ...
    <div class="font" ref="font">
      <h1 ref="a">believe in yourself</h1>
      <h1 ref="b">stay come with us erkelost</h1>
      <h1 ref="c">NetEase cloud music ! ! !</h1>
    </div>
  </div>
</template>
...
.font {
  ...
  h1 {
    ...
    background: linear-gradient(to right, rgb(207, 139, 13), rgb(231, 40, 206));
...
.app {
  position: relative;
  top: 80px;
  background: url("../assets/img/1.jpg") center center;
  width: 100%;
